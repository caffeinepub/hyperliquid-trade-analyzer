...
export default function OrderbookHeatmapView() {
  ...
  const { orderbook, isLoading, error, lastUpdated, refetch } =
  ...
  const handleDepthChange = (newDepth: string) => {
    setDepth(Number.parseInt(newDepth, 10));
  };

  const handleIntervalChange = (newInterval: string) => {
    setInterval(Number.parseInt(newInterval, 10));
  };
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Live visualization of Hyperliquid orderbook depth with color-coded
            intensity
          </CardDescription>
        </CardHeader>
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center gap-2">
                              <div
                                ...
                                style={{
                                  background:
                                    "linear-gradient(to right, oklch(0.75 0.15 145), oklch(0.35 0.20 145))",
                                }}
                              />
                              <span>
                                Bids (Buy orders): Unified green triangle
                              </span>
                            </div>
                          </div>
                          <div className="space-y-2">
                            <div className="flex items-center gap-2">
                              <div
                                ...
                                style={{
                                  background:
                                    "linear-gradient(to right, oklch(0.75 0.15 25), oklch(0.35 0.20 25))",
                                }}
                              />
                              <span>
                                Asks (Sell orders): Unified red triangle
                              </span>
                            </div>
                          </div>
                        </div>
                        <p className="text-xs text-muted-foreground">
                          Cluster mode displays bids and asks as unified
                          triangles with smooth color gradients. The larger
                          triangle indicates the dominant side by aggregate
                          depth (buy vs sell pressure). When more buy orders
                          exist, the green triangle is larger; when more sell
                          orders exist, the red triangle is larger.
                        </p>
                      </>
                    ) : (
                      <>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                          <div className="space-y-2">
                            <div className="flex items-center gap-2">
                              ...
                              />
                              <span>
                                Bids (Buy orders): Light green = low depth, Dark
                                green = high depth
                              </span>
                            </div>
                          </div>
                          <div className="space-y-2">
                            <div className="flex items-center gap-2">
                              ...
                              />
                              <span>
                                Asks (Sell orders): Light red = low depth, Dark
                                red = high depth
                              </span>
                            </div>
                          </div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          The bars view shows individual price levels with color
                          intensity representing the relative size of orders.
                          The mid price is indicated by a white line separating
                          bids and asks.
                        </p>
                      </>
                    )}
