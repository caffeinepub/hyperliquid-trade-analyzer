...
import TradeEntryChecker from "./components/TradeEntryChecker";
  ...
  if (!rootExists) {
    return (
      ...
      >
        ...
        <p>
          Der Root-Container konnte nicht gefunden werden. Bitte laden Sie die
          Seite neu.
        </p>
      </div>
    );
          ...
          <main className="flex-1 container mx-auto px-4 py-8">
            <Alert variant="destructive" className="max-w-2xl mx-auto">
              ...
              <AlertDescription>
                ...
                Seite neu oder versuchen Sie es mit einer anderen CSV-Datei.
              </AlertDescription>
            </Alert>
        ...
        <main className="flex-1 container mx-auto px-4 py-8">
          ...
          >
            <TabsList className="grid w-full max-w-3xl mx-auto grid-cols-4 mb-6">
              ...
              <TabsTrigger value="entry-checker">Entry Checker</TabsTrigger>
            ...
            <TabsContent value="entry-checker" className="mt-0">
              <TradeEntryChecker />
            </TabsContent>
